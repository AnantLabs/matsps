...
using matsps.AntAlgorithm.AntAlgData;               // данные алгоритма муравья
using matsps.AntAlgorithm.AntAlgLogic;              // логика алгоритма Муравья
using matsps.CommonData;               // совместные данные
using matsps.Parameters;               // параметры алгоритмов

namespace matsps.AntAlgorithm
{
    /// <summary>
