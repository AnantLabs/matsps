...
namespace Demo.WindowsForms
{
   public partial class MainForm : Form
   {
            ...
            //if(false)
            {
               ...
               GeoCoderStatusCode status = GeoCoderStatusCode.Unknow;
               {
                  ...
                  if(pos != null && status == GeoCoderStatusCode.G_GEO_SUCCESS)
                  {
                     ...
                     GMapMarker myCity = new GMarkerGoogle(pos.Value, GMarkerGoogleType.yellow);
                     myCity.ToolTipMode = MarkerTooltipMode.OnMouseOver;
                     myCity.ToolTipText = "Welcome to Russia!";
                     objects.Markers.Add(myCity);
                  }
               }

               // add some points in lithuania
               AddLocationLithuania("Тверь");
               AddLocationLithuania("Калуга");
               AddLocationLithuania("Ярославль");
               AddLocationLithuania("Владимир");
      ...
      {
         GeoCoderStatusCode status = GeoCoderStatusCode.Unknow;
         PointLatLng? pos = GMapProviders.GoogleMap.GetPoint("Russia, " + place, out status);
         if(pos != null && status == GeoCoderStatusCode.G_GEO_SUCCESS)
         {
